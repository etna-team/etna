...
- **Breaking:** Change signature of `Auto.objective`. Now it accepts extra parameter `config_mapping` (from hash to config). We moved interaction with configs from `ConfigSampler` to `Auto` ([#637](https://github.com/etna-team/etna/pull/637))
