...
- **Breaking:** Remove attributes `known_future`, `freq`, `current_df_level` and `current_df_exog_level` from `TSDataset` and make its the properties ([#630](https://github.com/etna-team/etna/pull/630))
-
