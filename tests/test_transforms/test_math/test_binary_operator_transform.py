...
def test_simple_change_target(simple_ts_: TSDataset, operand):
    ...
    transformer = binary_operator.BinaryOperationTransform(left_operand="feature", right_operand="target", operator=operand, out_column="target")
...
def test_simple_add_column(simple_ts_,operand):
    ...
    feature_vals = simple_ts_.df["segment"]["feature"].values
    checker_vals = ops[operand](feature_vals, target_vals)
    transformer = binary_operator.BinaryOperationTransform(left_operand="feature", right_operand="target",
