...
def test_transform_micro_category_expected(category_ts, expected_micro_category_ts):
    ...
    mean_encoder.fit_transform(category_ts)
    assert_frame_equal(
        category_ts.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]], expected_micro_category_ts._df, atol=0.01
    )
...
def test_transform_micro_global_mean_expected(category_ts, expected_micro_global_mean_ts):
    ...
    mean_encoder.fit_transform(category_ts)
    assert_frame_equal(
        category_ts.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]], expected_micro_global_mean_ts._df
    )
...
def test_transform_micro_make_future_expected(category_ts, expected_micro_category_make_future_ts):
    ...
    assert_frame_equal(
        future.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]], expected_micro_category_make_future_ts._df
    )
...
def test_transform_macro_category_expected(category_ts, expected_macro_category_ts):
    ...
    mean_encoder.fit_transform(category_ts)
    assert_frame_equal(
        category_ts.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]], expected_macro_category_ts._df, atol=0.01
    )
...
def test_transform_macro_global_mean_expected(category_ts, expected_macro_global_mean_ts):
    ...
    mean_encoder.fit_transform(category_ts)
    assert_frame_equal(
        category_ts.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]], expected_macro_global_mean_ts._df, atol=0.02
    )
...
def test_transform_macro_make_future_expected(category_ts, expected_macro_category_make_future_ts):
    ...
    assert_frame_equal(
        future.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]],
...
def test_ts_begin_nan_smooth_1(ts_begin_nan, expected_ts_begin_nan_smooth_1):
    ...
    assert_frame_equal(
        ts_begin_nan.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]], expected_ts_begin_nan_smooth_1._df, atol=0.01
    )
...
def test_ts_begin_nan_smooth_2(ts_begin_nan, expected_ts_begin_nan_smooth_2):
    ...
    mean_encoder.fit_transform(ts_begin_nan)
    assert_frame_equal(
        ts_begin_nan.loc[:, pd.IndexSlice[:, "mean_encoded_regressor"]], expected_ts_begin_nan_smooth_2._df, atol=0.01
    )
...
def test_mean_segment_encoder(mean_segment_encoder_ts, expected_mean_segment_encoder_ts):
    ...
    assert_frame_equal(
        mean_segment_encoder_ts.loc[:, pd.IndexSlice[:, "segment_mean"]],
        expected_mean_segment_encoder_ts.loc[:, pd.IndexSlice[:, "segment_mean"]],
        atol=0.01,
    )
...
def test_multiple_nan_target_category_ts(multiple_nan_target_category_ts, expected_multiple_nan_target_category_ts):
    ...
    assert_frame_equal(
        multiple_nan_target_category_ts.loc[:, pd.IndexSlice[:, "regressor_mean"]],
...
def test_multiple_nan_target_two_segments_ts(
    ...
    assert_frame_equal(
        multiple_nan_target_two_segments_ts.loc[:, pd.IndexSlice[:, "regressor_mean"]],
