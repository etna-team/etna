...
from etna.datasets.internal_datasets import load_dataset, datasets_dict, _DOWNLOAD_PATH
...
def test_load_custom_dataset():
    update_dataset_dict(
        dataset_name="custom_internal_dataset",
        get_dataset_function=get_custom_dataset,
        freq="D"
    )
