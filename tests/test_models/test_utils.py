...
@pytest.mark.parametrize(
    ...
    [
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), "2020-02-01", None, 5),
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), "2020-02-01", "2020-02-05", None),
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), None, "2020-02-05", 5),
        (pd.to_datetime(pd.Series(["2020-02-01"])), pd.offsets.Day(), "2020-02-01", None, 5),
...
@pytest.mark.parametrize(
    "timestamps, freq, start, end, periods",
    [
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), None, None, None),
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), "2020-02-01", None, None),
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), None, "2020-02-05", None),
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), None, None, 5),
        (pd.to_datetime(pd.Series(["2020-02-01", "2020-02-03"])), pd.offsets.Day(), "2020-02-01", "2020-02-05", 5),
