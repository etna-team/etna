...
@pytest.mark.parametrize(
    ...
    [
        (GaussianLoss(), torch.tensor([0.0]), torch.tensor([1.0]), torch.tensor([1.0]), torch.tensor([0.0])),
        (GaussianLoss(), torch.tensor([10.0]), torch.tensor([100.0]), torch.tensor([1.0]), torch.tensor([10.0])),
        (NegativeBinomialLoss(), torch.tensor([2.0]), torch.tensor([0.1]), torch.tensor([1.0]), torch.tensor([2.0])),
        (NegativeBinomialLoss(), torch.tensor([0.6]), torch.tensor([0.1]), torch.tensor([1.0]), torch.tensor([0.6])),
    ],
)
