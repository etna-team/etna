...
def test_plot_anomalies_fail_incorrect_start_end_type(params, match, example_tsdf_int_timestamp):
    anomaly_dict = {"segment_1": [10, 100], "segment_2": [20, 200]}
    with pytest.raises(ValueError, match=match):
        plot_anomalies(ts=example_tsdf_int_timestamp, anomaly_dict=anomaly_dict, **params)
...
def test_plot_anomalies_interactive_fail_incorrect_start_end_type(params, match, example_tsdf_int_timestamp):
