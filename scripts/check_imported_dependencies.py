...
missed_deps = [module for module in modules if module not in ["sklearn", "tsfresh", "pkg_resources", "pytorch_lightning"] and min([lev_dist(module, dep) for dep in pyproject_deps]) > 2]
